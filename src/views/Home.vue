		...
		<div class="container">
			...
			<div class="row">
				<div
					...
					v-bind:key="index"
				>
					<div class="product-grid2 bg-white">
						<div class="product-image2">
							<a href="#">
								<img
									class="pic-1 img-thumbnail img-responsive"
									src="http://bestjquery.com/tutorial/product-grid/demo9/images/img-3.jpg"
								/>
								<img
									class="pic-2 img-thumbnail img-responsive"
...
<script>
	...
	import { PRODUCTS, ADD_CART } from "../services/apis.js";
